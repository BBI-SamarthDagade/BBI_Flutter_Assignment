...
//   void _skipProfileSetup() {
//     final user = FirebaseAuth.instance.currentUser;
//       final username =  _nameController.text;// Default username for skipped profiles

//     // Trigger the backend call via your Bloc or API
//     final bloc = context.read<ProfileBloc>();
//     if(user!= null){
//     bloc.add(
//       SaveProfileEvent(
//         ProfileModel(
//           username: username, // Store only the username
//           phoneNumber: '',    // Empty phone number
//           address: '',        // Empty address
//           imageUrl: '',       // No profile image
//         ),
//         user.uid, // Pass the user ID for storage
//       ),
//     );
//     }
//     Navigator.pushReplacementNamed(context, '/home');
